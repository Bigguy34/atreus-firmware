...
int layer2[44] = {
    ...
    0, 0, 0, 0, 0, KEYBOARD_LEFT_ALT, KEYBOARD_LEFT_SHIFT, KEY_F1, KEY_F2, KEY_F3, KEY_F12,
    KEY_ESC, FUNCTION(0), KEYBOARD_LEFT_GUI, KEYBOARD_LEFT_SHIFT, KEY_BACKSPACE, KEYBOARD_LEFT_CTRL, KEY_SPACE, PRE_FUNCTION(1), 0, 0, KEY_ENTER };
